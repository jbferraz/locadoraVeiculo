                ...
                <tr><td align='center'>
                        <div id="quatro"> 
                            <form>
                                ...
                                $resultado = mysql_query("Select * from Locacao, Veiculo, Cliente where disponivel=0 and Cliente_idCliente=idCliente and Veiculo_idVeiculo=idVeiculo and status=1 order by dataLocacao") or die("Não é possível consultar veículos locados.");
