                        ...
                        <div id="quatro"> 
                            <form>
                                ...
                                while ($linha = mysql_fetch_array($resultado)) {
                                    ...
                                    $descCatVeiculo = $linha["nomeMarca"];
                                    print("<tr><td align='center'>$Codigo</td>");
                                    print("<td>$descCatVeiculo</td>");
                                    print("<td><a href='../models/deletaMarca.php?cod=$Codigo'>Deletar</a></td>"); //Refatorar Deletar
                                    print("<td><a href='../models/alteraMarca.php?cod=$Codigo'>Alterar</a></td></tr>"); //Refatorar Alterar
                                }
                                print("</table></center>");
                                ?>
